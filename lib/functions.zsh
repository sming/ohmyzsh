...
# WARNING - DUPLICATE FUNCTIONS !!!
# WARNING - DUPLICATE FUNCTIONS !!!
# You will find another "# PSK Functions" comment ~halfway down this file. This is cos I am lazy/depressed
# and cannot bear the drudgery of merging in a diverged version of this file.
# HENCE THERE ARE DUPLICATES OF ~60% OF THIS FILE
##################################
